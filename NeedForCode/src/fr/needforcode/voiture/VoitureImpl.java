...
public class VoitureImpl implements Voiture {
	...
	/**
	 * · Commande (dépend de c) : αcc
	 */
	private double alpha_c;
	
	/**
	 * · Frottements (négative) : αf mv + βf m
	 */
	private double alpha_f, beta_f;
	
	/**
	 * · Inertie (positive) : αimv
	 */
	...
	/**
	  * Méthode modifiant la pisiton de la voiture selon les paramètres physiques liés au dérapage de la voiture
	  * 
	  * @param a Commande c
	  */
	...
	/**
	  * Méthode modifiant la pisiton de la voiture selon les paramètres physiques de frotement, inertie et commande
	  * 
	  * @param a Commande c
	  */
